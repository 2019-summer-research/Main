...
public class FacesAPIMethod extends MicrosoftApiService {
    public FacesAPIMethod(byte[] imageByteArray, String PersonGroup, String PersonID){
        ...
        this.setReturnType(FacesResponseElement.class);
    }
